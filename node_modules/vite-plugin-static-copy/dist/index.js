...
*/
const isSubdirectoryOrEqual = (a, b) => {
...
const groupTargetsByDirectoryTree = (targets) => {
	const targetsWithOrder = targets.map((target, order) => ({
		...target,
		order
	})).sort((a, b) => a.resolvedDest === b.resolvedDest ? 0 : a.resolvedDest > b.resolvedDest ? 1 : -1);
	const groups = {};
	...
	for (const g of groupList) g.sort((a, b) => a.order - b.order);
	return groupList;
};
...
const updateFileMapFromTargets = (targets, fileMap) => {
	fileMap.clear();
